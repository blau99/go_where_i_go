class PhotosController < ApplicationController
  ...
  def index
    ...
    @photos = @q.result(:distinct => true).includes(:user, :point_of_interest, :accommodation, :restaurant).page(params[:page]).per(10)
  ...
  def create
    ...
    @photo.accommodation_id = params[:accommodation_id]
    @photo.point_of_interest_id = params[:point_of_interest_id]
